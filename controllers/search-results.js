...
const logError = (functionName) => `OH NO! Error with ${functionName} in Search-Results Controllers:`;
const resError = (functionName) => `OH NO! Internal Server Error with ${functionName} in Search-Results Controllers:`;
